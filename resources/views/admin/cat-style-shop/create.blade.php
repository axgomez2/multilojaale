<x-admin-layout title="Criar Nova Categoria de Disco">
    <div class="px-6 py-4">
        <!-- Cabeçalho -->
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Nova Categoria de Disco</h1>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form action="{{ route('admin.cat-style-shop.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    <p class="text-xs text-gray-500">
                        Crie categorias para organizar seus discos em seções como DJs, Colecionadores, Lotes, etc.
                    </p>
                </div>
