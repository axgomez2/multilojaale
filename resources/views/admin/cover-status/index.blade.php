<x-admin-layout title="Gerenciar Status de Capa">
    <div class="px-6 py-4">
        ...
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Status de Capa</h1>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="border-b px-6 py-4">
                <h2 class="text-lg font-semibold text-gray-700">Todos os Status de Capa</h2>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 text-sm text-left text-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    @if($status->color_code)
                                        <div class="w-7 h-7 rounded" style="background-color: {{ $status->color_code }}"></div>
                                    @else
                                ...
                                <td class="px-6 py-4 flex gap-2">
                                    ...
                                    <form action="{{ route('admin.cover-status.destroy', $status->id) }}" method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500">Nenhum status de capa encontrado</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
