<x-app-layout>
            ...
            <!-- Hero Section -->
            <div class="xl:min-h-[500px] bg-blue-50 px-4 sm:px-10 py-10">
                <div class="grid xl:grid-cols-2 justify-center items-center gap-10">
                    <div>
                        <div class="max-w-3xl max-xl:mx-auto max-xl:text-center">
                            <h1 class="md:text-5xl text-4xl font-bold md:!leading-[55px]">Schedule meetings effortlessly
                            </h1>
                            <p class="text-base leading-relaxed mt-6">Eliminate back-and-forth emails
                            ...
                            <div
                                class="bg-white shadow-sm border border-gray-200 mt-12 flex px-1 py-1.5 rounded-lg overflow-hidden max-xl:max-w-xl max-xl:mx-auto">
                                <input type='email' placeholder='Enter your email address'
                                    class="w-full outline-none bg-white px-4" />
                                <div class="ml-auto sm:min-w-[200px] min-w-[120px]">
                                    <button type='button'
                                        class="bg-blue-600 hover:bg-blue-700 cursor-pointer transition-all text-white font-medium rounded-lg px-4 py-2.5 block ml-auto">Start
                                        Free</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <section class="mt-12">
                            <div class="container mx-auto">
                                <div class="grid min-[450px]:grid-cols-2 md:grid-cols-3 gap-8 text-center">
                                    <div>
                                        <h3 class="text-3xl font-semibold text-blue-600">3M+</h3>
                                        <p class="mt-3 font-medium text-base">Meetings Scheduled</p>
                                    </div>
                                    <div>
                                        <h3 class="text-3xl font-semibold text-blue-600">50K+</h3>
                                        <p class="mt-3 font-medium text-base">Active Users</p>
                                    </div>
                                    <div>
                                        <h3 class="text-3xl font-semibold text-blue-600">99.9%</h3>
                                        <p class="mt-3 font-medium text-base">Uptime</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                    ...
                    <div class="xl:aspect-[350/251]">
                        <img src="https://readymadeui.com/images/meeting-img.webp" alt="banner img"
                            class="w-full h-full object-contain max-xl:object-top" />
                    </div>
                </div>
            </div>
            ...
            <!-- Features Section -->
            <div id="features"
                class="md:mt-28 mt-16 py-16 bg-gradient-to-t from-gray-200 via-gray-50 to-gray-200 px-4 sm:px-10">
                <div class="container mx-auto">
                    <div class="text-center max-w-4xl mx-auto">
                        <p class="text-blue-600 font-semibold mb-2">POWERFUL FEATURES</p>
                        <h2 class="text-2xl md:text-3xl font-bold leading-relaxed">Everything you need to schedule with
                            confidence</h2>
                        <div class="max-w-2xl mx-auto mt-6">
                            <p class="leading-relaxed">Our comprehensive platform offers all the
                                tools you need to
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
                        <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
                            <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-6">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-600 fill-current"
                            ...
                            <h3 class="text-lg font-semibold mb-2">Calendar Integration</h3>
                            <p class="leading-relaxed">Seamlessly sync with Google, Outlook, Apple, and
                        ...
                        <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
                            <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-6">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-blue-600"
                                    viewBox="0 0 64 64">
                                    <path
                            ...
                            <h3 class="text-lg font-semibold mb-2">Time Zone Intelligence</h3>
                            <p class="leading-relaxed">Automatically detect and adjust to client time
                        ...
                        <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Video Meeting Links</h3>
                            <p class="leading-relaxed">Auto-generate Zoom, Teams, or Google Meet links
                        ...
                        <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Smart Reminders</h3>
                            <p class="leading-relaxed">Automated email and SMS reminders to reduce
                        ...
                        <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Group Scheduling</h3>
                            <p class="leading-relaxed">Find the perfect time for multiple participants
                        ...
                        <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Custom Integrations</h3>
                            <p class="leading-relaxed">Connect with your favorite tools via Zapier, our
            ...
            <div id="how-it-works" class="md:mt-28 mt-16 px-4 sm:px-10">
                <div class="container mx-auto">
                    <div class="text-center max-w-4xl mx-auto">
                        <p class="text-blue-600 font-semibold mb-2">SIMPLE PROCESS</p>
                        <h2 class="text-2xl md:text-3xl font-bold leading-relaxed">How It Works</h2>
                        <div class="max-w-2xl mx-auto mt-6">
                            <p class="leading-relaxed">Our intuitive platform makes scheduling
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
                        <div class="text-center">
                            <div
                                class="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
                                1</div>
                            <h3 class="text-lg font-semibold mb-2">Create Your Schedule</h3>
                            <p class="leading-relaxed">Define your availability, meeting types, and
                        ...
                        <div class="text-center">
                            ...
                            <p class="leading-relaxed">Send your personalized booking link via email,
                        ...
                        <div class="text-center">
                            <div
                                class="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
                                3</div>
                            <h3 class="text-lg font-semibold mb-2">Meet with Confidence</h3>
                            <p class="leading-relaxed">Clients book available slots, receive automatic
            ...
            <div id="integrations"
                class="py-16 bg-gradient-to-t from-blue-100 via-blue-50 to-blue-100 md:mt-28 mt-16 px-4 sm:px-10">
                <div class="container mx-auto">
                    <div class="text-center max-w-4xl mx-auto">
                        <p class="text-blue-600 font-semibold mb-2">SEAMLESS CONNECTIONS</p>
                        <h2 class="text-2xl md:text-3xl font-bold leading-relaxed">Integrate with Your Favorite Tools
                        </h2>
                        <div class="max-w-2xl mx-auto mt-6">
                            <p class="leading-relaxed">We connects with the apps you already use,
                                creating a seamless workflow.</p>
                        </div>
                    </div>

                    <div
                        class="grid min-[500px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 items-center mt-16">
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 512 512">
                                <path fill="#0085f7"
                            ...
                            <h6 class="font-semibold text-base">Google Calendar</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 512 512">
                            ...
                            <h6 class="font-semibold text-base">Microsoft Teams</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 512 512">
                            ...
                            <h6 class="font-semibold text-base">Zoom</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 512 512">
                            ...
                            <h6 class="font-semibold text-base">Slack</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 256 256">
                                <path fill="#FF4A00"
                            ...
                            <h6 class="font-semibold text-base">Zapier</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 512 512">
                            ...
                            <h6 class="font-semibold text-base">Salesforce</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 fill-[#ff5c35]"
                            ...
                            <h6 class="font-semibold text-base">HubSpot</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0"
                            ...
                            <h6 class="font-semibold text-base">Stripe</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 512 512">
                            ...
                            <h6 class="font-semibold text-base">Gmail</h6>
                        </div>
                        <div
                            class="p-4 bg-white rounded-lg shadow-sm flex items-center justify-center gap-4 h-24 hover:shadow-md transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 shrink-0" viewBox="0 0 48 48">
                                <path fill="#03A9F4"
                            ...
                            <h6 class="font-semibold text-base">Microsoft Outlook</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- pricing section -->
            <div id="pricing" class="px-4 sm:px-10 md:mt-28 mt-16">
                <div class="max-w-5xl max-lg:max-w-2xl mx-auto">
                    <div class="container mx-auto">
                        <div class="text-center max-w-4xl mx-auto">
                            <p class="text-blue-600 font-semibold mb-2">FLEXIBLE PLANS</p>
                            <h2 class="text-2xl md:text-3xl font-bold leading-relaxed">Choose the Perfect Plan</h2>
                            <div class="max-w-2xl mx-auto mt-6">
                                <p class="leading-relaxed">Select a plan that fits your needs, whether
                                    you're an
                                    individual or part of a large team.</p>
                            </div>
                        </div>

                        <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-6 max-sm:max-w-sm max-sm:mx-auto mt-16">

                            <div
                                class="relative bg-white shadow-sm rounded-3xl p-6 border border-gray-200 hover:border-blue-600 transition-all">
                                <h4 class="text-lg font-medium mb-4">Basic</h4>
                                <h3 class="text-4xl font-semibold">$4.50<sub
                                        class="text-slate-500 font-medium text-sm ml-1">/
                                        month</sub></h3>
                                ...
                                <div>
                                    <ul class="space-y-4">
                                        <li class="flex items-center font-medium">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                class="mr-3 bg-blue-100 fill-blue-600 rounded-full p-[3px] w-[18px] h-[18px]"
                                                viewBox="0 0 24 24">
                                                <path
                                    ...
                                    <div class="min-h-[40px] mt-6">
                                        <button type="button"
                                            class="cursor-pointer absolute bottom-6 left-0 right-0 mx-auto w-11/12 px-4 py-2 font-medium tracking-wide bg-blue-600 hover:bg-blue-700 text-white rounded-xl">Get
                                            Started</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                class="relative bg-white shadow-sm rounded-3xl p-6 border border-gray-200 hover:border-blue-600 transition-all">
                                <h4 class="text-lg font-medium mb-4">Professional</h4>
                                <h3 class="text-4xl font-semibold">$14.50<sub
                                        class="text-slate-500 font-medium text-sm ml-1">/
                                        month</sub></h3>
                            ...
                            <div
                                class="relative bg-white shadow-sm rounded-3xl p-6 border border-gray-200 hover:border-blue-600 transition-all">
                                <h4 class="text-lg font-medium mb-4">Enterprise</h4>
                                <h3 class="text-4xl font-semibold">$24.50<sub
                                        class="text-slate-500 font-medium text-sm ml-1">/
                                        month</sub></h3>
            ...
            <!-- Testimonial section -->
            <div id="testimonials" class="md:mt-28 mt-16 px-4 sm:px-10">
                <div class="container mx-auto">
                    <div class="text-center max-w-4xl mx-auto">
                        <p class="text-blue-600 font-semibold mb-2">CUSTOMER STORIES</p>
                        <h2 class="text-2xl md:text-3xl font-bold leading-relaxed">What Our Users Say</h2>
                        <div class="mt-6 max-w-2xl mx-auto">
                            <p class="leading-relaxed">Don't just take our word for it - hear from
                                professionals
                    ...
                    <div
                        ...
                        <div>
                            <div class="flex flex-col items-center">
                                <img src="https://readymadeui.com/team-2.webp"
                                    class="w-24 h-24 rounded-full border-2 border-blue-600" />
                                <div class="mt-6">
                            ...
                            <div class="mt-6">
                                <p class="leading-relaxed">This service has saved me
                                    countless hours of
                        ...
                        <div>
                            ...
                            <div class="mt-6">
                                <p class="leading-relaxed">Since implementing this service,
                                    my booking rate
                        ...
                        <div>
                            ...
                            <div class="mt-6">
                                <p class="leading-relaxed">Our team manages over 200 client
                                    meetings per
                        ...
                        <div>
                            ...
                            <div class="mt-6">
                                <p class="leading-relaxed">It's calendar integration is
                        ...
                        <div>
                            ...
                            <div class="mt-6">
                                <p class="leading-relaxed">It's buffer time feature has been
                        ...
                        <div>
                            ...
                            <div class="mt-6">
                                <p class="leading-relaxed">As a therapist, client
            ...
            <!-- CTA Section -->
            <div class="py-16 bg-gradient-to-t from-blue-400 via-blue-500 to-blue-600 md:mt-28 mt-16 px-4 sm:px-10">
                <div class="container mx-auto text-center">
                    <div class="text-center max-w-4xl mx-auto">
                        <h2 class="text-white text-2xl md:text-3xl font-bold leading-relaxed">Ready to transform your
                            scheduling
                            experience?</h2>
                        <div class="mt-6 max-w-2xl mx-auto">
                            <p class="leading-relaxed text-white">Join thousands of professionals who've eliminated
                                scheduling headaches with It.</p>
                        </div>
                    </div>
                    <div class="flex flex-col sm:flex-row justify-center gap-4 mt-12">
                        <button class="cursor-pointer bg-white px-6 py-3 rounded-lg hover:bg-gray-100 transition font-medium">Start
                            Your Free Trial</button>
                        <button
                            class="cursor-pointer bg-transparent border border-white text-white px-6 py-3 rounded-lg hover:bg-white hover:text-slate-900 transition font-medium">See
                            Demo</button>
                    </div>
                </div>
            </div>
            ...
            <!-- FAQ section -->
            <div id="faq" class="md:mt-28 mt-16 px-4 sm:px-10">
                <div class="max-w-4xl mx-auto">
                    <div class="divide-y divide-gray-300 container mx-auto">
                        <div class="text-center max-w-4xl mx-auto pb-16">
                            <p class="text-blue-600 font-semibold mb-2">COMMON QUESTIONS</p>
                            <h2 class="text-2xl md:text-3xl font-bold leading-relaxed">Frequently asked questions</h2>
                        </div>
                        <div class="accordion" role="accordion">
                            <button type="button"
                                class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-4 hover:text-blue-600 flex items-center">
                                <span class="mr-4">Are there any fees for rescheduling or canceling a meeting?</span>
                            ...
                            <div class="content pb-4 max-h-[1000px] overflow-hidden transition-all duration-300">
                                <p class="leading-relaxed">Rescheduling is free if done at least 24 hours
                                    before the
                        ...
                        <div class="accordion" role="accordion">
                            <button type="button"
                                class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-4 hover:text-blue-600 flex items-center">
                                <span class="mr-4">What are the available time slots for scheduling meetings?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42"
                                    class="w-3 fill-current ml-auto shrink-0">
                                    <path class="plus"
                                        d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                            ...
                            <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                                <p class="leading-relaxed">Our scheduling system offers flexible time
                                    slots from 8 AM
                        ...
                        <div class="accordion" role="accordion">
                            <button type="button"
                                class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-4 hover:text-blue-600 flex items-center">
                                <span class="mr-4">Can I invite multiple participants to a scheduled meeting?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42"
                                    class="w-3 fill-current ml-auto shrink-0">
                                    <path class="plus"
                                        d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                            ...
                            <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                                <p class="leading-relaxed">Yes, you can invite up to 10 participants with
                                    our
                        ...
                        <div class="accordion" role="accordion">
                            <button type="button"
                                class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-4 hover:text-blue-600 flex items-center">
                                <span class="mr-4">How do I integrate the scheduling system with my calendar?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42"
                                    class="w-3 fill-current ml-auto shrink-0">
                                    <path class="plus"
                                        d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                            ...
                            <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                                <p class="leading-relaxed">Our scheduling service integrates seamlessly
                                    with Google
                        ...
                        <div class="accordion" role="accordion">
                            <button type="button"
                                class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-4 hover:text-blue-600 flex items-center">
                                <span class="mr-4">Are there automatic reminders for scheduled meetings?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42"
                                    class="w-3 fill-current ml-auto shrink-0">
                                    <path class="plus"
                                        d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                            ...
                            <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                                <p class="leading-relaxed">Yes, all participants receive automatic email
                                    reminders 24
                        ...
                        <div class="accordion" role="accordion">
                            <button type="button"
                                class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-4 hover:text-blue-600 flex items-center">
                                <span class="mr-4">How can I set up recurring meetings?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42"
                                    class="w-3 fill-current ml-auto shrink-0">
                                    <path class="plus"
                                        d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                            ...
                            <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                                <p class="leading-relaxed">To set up recurring meetings, select the
                                    "Recurring"
        ...
        <!-- footer section -->
        <footer class="bg-gray-100 md:mt-28 mt-16 px-4 sm:px-10 pt-16 pb-6">
            <div class="flex flex-wrap justify-between gap-10">
                <div class="max-w-md">
                    ...
                    <div class="mt-6">
                        <p class="leading-relaxed text-sm">Our service is a comprehensive scheduling platform that
                ...
                <div class="max-lg:min-w-[140px]">
                    <h4 class="font-semibold relative">Scheduling</h4>

                    <ul class="mt-6 space-y-4">
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">One-on-One Meetings</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Group Scheduling</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Recurring Meetings</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Round Robin</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Collective Scheduling</a>
                        </li>
                    </ul>
                </div>

                <div class="max-lg:min-w-[140px]">
                    <h4 class="font-semibold relative">Integrations</h4>
                    <ul class="space-y-4 mt-6">
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Google Calendar</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Microsoft Outlook</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Apple Calendar</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Zoom</a>
                        </li>
                    </ul>
                </div>

                <div class="max-lg:min-w-[140px]">
                    <h4 class="font-semibold relative">Company</h4>

                    <ul class="space-y-4 mt-6">
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">About us</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Careers</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Blog</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Testimonials</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Press</a>
                        </li>
                    </ul>
                </div>

                <div class="max-lg:min-w-[140px]">
                    <h4 class="font-semibold relative">Resources</h4>

                    <ul class="space-y-4 mt-6">
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Help Center</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">API Documentation</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Scheduling Tips</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Contact Support</a>
                        </li>
                        <li>
                            <a href='javascript:void(0)' class="hover:text-blue-700">Community</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-wrap max-md:flex-col gap-4">
                <ul class="md:flex md:space-x-6 max-md:space-y-2">
                    <li>
                        <a href='javascript:void(0)' class="hover:text-blue-700">Terms of Service</a>
                    </li>
                    <li>
                        <a href='javascript:void(0)' class="hover:text-blue-700">Privacy Policy</a>
                    </li>
                    <li>
                        <a href='javascript:void(0)' class="hover:text-blue-700">Security</a>
                    </li>
                </ul>

                <p class="md:ml-auto">© Your company. All rights reserved.</p>
            </div>
        </footer>
