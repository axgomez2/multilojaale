...
<div class="bg-gray-50 min-h-screen">
    ...
    <!-- hero content -->
    <section style="background-image: url('/assets/images/hero.webp')" class="bg-no-repeat bg-cover bg-center">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 
        text-sm text-white bg-black rounded-full  
        hover:bg-yellow-400 hover:text-black transition-colors " role="alert">
            <span class="text-xs  rounded-full text-white px-4 py-1.5 mr-3">WHOWWWW</span> <span class="text-sm font-medium">Estamos chegando!!!</span> 
        ...
        <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div class="flex flex-wrap justify-center items-center mt-8 text-white sm:justify-between">
  <!-- Instagram -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @else
            ...
            <div class="bg-slate-800 rounded-lg p-8 text-center">
                <p class="text-white text-lg">Novos discos em destaque em breve!</p>
            </div>
        @endif
    </div>
</section>
        ...
        @if($categoryData['vinyls']->isNotEmpty())
            <div class="md:hidden mb-8">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-2xl font-bold text-white" style="font-family: 'Montserrat', 'Inter', 'Arial', sans-serif;">{{ $categoryData['category']->nome }}</h2>
                    <a href="{{ route('site.category', $categoryData['category']->slug) }}" class="text-sm text-indigo-400 hover:text-indigo-300 flex items-center">
                        Ver todos
                ...
                <div x-data="{ scroll: 0, totalItems: {{ $categoryData['vinyls']->count() }}, visibleItems: 1 }" class="relative">
