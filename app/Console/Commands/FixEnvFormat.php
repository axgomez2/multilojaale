...
class FixEnvFormat extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fix:env-format';
     ...
     * @var string
     */
    protected $description = 'Fix .env file formatting issues';
    ...
    {
        $this->info('Fixing .env file formatting...');
        
        // Essential mail configurations with proper quoting
        $envUpdates = [
            'APP_NAME' => '"RDV DISCOS"',
        ...
        $this->info('.env file formatting fixed!');
